...
### Coverage Reference (risk-based, not quotas)

These are risk-prioritized reference bands, not numeric targets to chase — consistent
with the Coverage Rules below ("percentage alone is meaningless"). Use them to decide
*where* untested behavior is unacceptable (high-risk rows), not to game a project number.

| Area | Floor (high-risk gap unacceptable below this) | Healthy |
|------|---------|-------|
| Auth flows | 90% | 100% |
