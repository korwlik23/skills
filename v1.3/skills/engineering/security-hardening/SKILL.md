...
Per-framework hardening checklists (Laravel, Next.js/Node.js, SvelteKit) are in
`references/framework-security.md` — load it when hardening one of those stacks. The
OWASP coverage and framework-agnostic rules above remain the source of truth.
