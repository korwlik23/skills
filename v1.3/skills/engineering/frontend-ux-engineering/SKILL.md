...
- One view/template per screen. Never render every screen of a module through a single parameterized shell template — a placeholder shell that only swaps labels per section is a god page, not N screens (`RULES.md` Structure Before Code).
