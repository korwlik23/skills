...
> These are version-agnostic checklists. Per `../../RULES.md` §10, always read the
> framework's official upgrade guide for the *actual* source and target versions
> before acting; do not assume version-specific steps from this file.
