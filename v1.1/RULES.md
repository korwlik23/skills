...
> **Pack version: v1.1.** v1.1 adds an enforced *Workflow Discipline Layer* and six
> lifecycle skills on top of v1's domain knowledge. The discipline concepts are adapted
> from the Superpowers methodology by Jesse Vincent (MIT — github.com/obra/superpowers),
> reworked to fit this pack's contract, language, and tone. v1 remains unchanged.
